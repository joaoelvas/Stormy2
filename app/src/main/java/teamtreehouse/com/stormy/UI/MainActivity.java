...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 38.5333;
        final double longitude = -8.9;
        final String units = "si";

        mRefreshImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getForecast(latitude, longitude, units);
            }
        });

//        Button dButton = (Button) findViewById(R.id.dailyButton);
//
...
//        });
    ...
    private void getForecast(double latitude, double longitude, String units) {
        String apiKey = "eb7552574fd785b97799c8c89c8b0e10";
    ...
    private Hour[] getHourlyForecast(String jsonData) throws JSONException{
        ...
        for(int i = 0; i < data.length(); i++) {
            ...
            hour.setTime(tData.getLong("time"));
            hour.setSummary(tData.getString("summary"));
            hour.setTemperature(tData.getDouble("temperature"));
            hour.setIcon(tData.getString("icon"));
    ...
    private Day[] getDailyForecast(String jsonData) throws JSONException{
        ...
        for(int i = 0; i < data.length(); i++) {
            ...
            day.setTime(tData.getLong("time"));
            day.setSummary(tData.getString("summary"));
            day.setTemperatureMax(tData.getDouble("temperatureMax"));
            day.setIcon(tData.getString("icon"));
